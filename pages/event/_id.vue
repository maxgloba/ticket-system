<template>
  <section class="page-event">
    <div class="container">
      <EventBanner v-if="$route.params.id" :campaignId="$route.params.id" />
      <EventSlider v-if="$route.params.id" :campaignId="$route.params.id" />
...
export default {
  ...
  mounted(){
    this.$store.dispatch('global/getOrders', this.$route.params.id)
  }
}
</script>
